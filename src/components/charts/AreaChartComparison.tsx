...
export type AreaChartComparisonData = {
    month: string;
    value: number;
    lastYearValue: number;
};

export type AreaChartComparisonProps = {
    title: string;
    categories: { key: string, title: string }[]; // e.g., ["unique-visitors", "total-visits"]
    data: {
        key: string;
        title: string;
        value: number;
        ...
        chartData: AreaChartComparisonData[];
    }[];
} & Omit<CardProps, "children">;


// Helper functions (could be props but keeping self contained for ease)
...
export const AreaChartComparison = React.forwardRef<HTMLDivElement, AreaChartComparisonProps>(
...
AreaChartComparison.displayName = "AreaChartComparison";
