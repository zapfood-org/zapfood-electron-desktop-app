...
export type BarChartMultipleData = {
    weekday: string;
    [key: string]: string | number;
};

export type BarChartMultipleProps = {
    title: string;
...
export const BarChartMultiple = React.forwardRef<HTMLDivElement, BarChartMultipleProps>(
...
BarChartMultiple.displayName = "BarChartMultiple";
