...
export function InvoicesPage() {
    ...
    const prevFiltersRef = useRef({ filterStatus, filterPaymentMethod, searchQuery });
    ...
    const filteredInvoices = useMemo(() => {
        return invoices.filter((invoice) => {
            ...
            if (filterPaymentMethod !== "all" && invoice.paymentMethod !== filterPaymentMethod) {
                return false;
            }
    ...
    useEffect(() => {
        ...
        if (filtersChanged) {
            ...
            prevFiltersRef.current = { filterStatus, filterPaymentMethod, searchQuery };
        }
            ...
            <div className="flex flex-col flex-1 overflow-hidden">
                ...
                <div className="flex items-center gap-4 p-6">
                    ...
                    <Select
                        ...
                        selectedKeys={filterPaymentMethod !== "all" ? [filterPaymentMethod] : []}
                        onSelectionChange={(keys) => {
                            const value = Array.from(keys)[0] as string;
