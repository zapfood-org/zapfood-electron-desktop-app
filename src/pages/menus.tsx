...
export function MenusPage() {
  ...
  const [selectedMenu, setSelectedMenu] = useState<MenuWithProducts | null>(
    null
  );
  ...
  const [newMenuStatus, setNewMenuStatus] = useState<"active" | "inactive">(
    "active"
  );
  ...
  const [editMenuStatus, setEditMenuStatus] = useState<"active" | "inactive">(
    "active"
  );
  ...
  const handleUpdateMenu = async (onClose: () => void) => {
    ...
    try {
      ...
      await api.patch(`/menus/${selectedMenu.id}`, payload, {
        headers: {
          "Content-Type": "application/json",
        },
      });
  ...
  const handleAddSelectedProducts = async () => {
    ...
    const productsToAdd = products.filter(
      (p) =>
        selectedProducts.has(p.id) && !selectedMenu.productIds?.includes(p.id)
    );
        ...
        <div className="flex-1 flex flex-col">
          {selectedMenu ? (
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-2">
                      ...
                      <span className="text-xs text-default-500">
                        {selectedMenu.products.length}{" "}
                        {selectedMenu.products.length === 1
                          ? "produto"
                          : "produtos"}
                      </span>
                    </div>
            ...
            <div className="flex flex-col items-center justify-center h-full text-center">
              ...
              />
              <p className="text-default-500">
                Selecione um cardápio para ver os produtos
              </p>
            </div>
          )}
        </div>
          ...
          {(onClose) => (
            <>
              ...
              <ModalFooter>
                ...
                <Button
                  color="primary"
                  onPress={() => handleCreateMenu(onClose)}
            ...
            <>
                    ...
                    <div className="flex flex-col items-center justify-center p-12 text-center">
                      <p className="text-default-500">
                        {searchProduct
                          ...
                          : "Todos os produtos já estão no cardápio"}
                      </p>
                    </div>
                  ) : (
                        ...
                        return (
                          <Card
                            ...
                            className={`transition-all cursor-pointer ${
                              isSelected
                                ? "border-primary border bg-primary-50 dark:bg-primary-950/20"
              ...
              <ModalFooter>
                ...
                <Button
                  ...
                  startContent={
                    !isAddingProducts ? (
                      <AddCircle size={18} weight="Outline" />
                    ) : undefined
                  }
                >
                  Adicionar{" "}
          ...
          {(onClose) => (
            <>
              ...
              <ModalFooter>
                ...
                <Button
                  color="primary"
                  onPress={() => handleUpdateMenu(onClose)}
