            ...
            <div className="flex flex-col flex-1 overflow-hidden">
                ...
                <div className="flex items-center gap-4 px-6 py-3">
                    <Input
                        ...
                        startContent={<Magnifer size={18} weight="Outline" className="text-default-400" />}
                        className="max-w-xs"
                    />
                    <Chip variant="flat" color="default">
                        {filteredPrinters.length} impressora{filteredPrinters.length !== 1 ? "s" : ""}
                    </Chip>
                </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-6">
                        {filteredPrinters.length > 0 ? (
                                    ...
                                    <CardHeader className="flex items-start justify-between pb-2">
                                        <div className="flex items-start gap-3 flex-1 min-w-0">
                                            <div className="p-2 rounded-lg bg-primary/10 flex-shrink-0">
                                                <Printer size={24} weight="Outline" className="text-primary" />
                                            </div>
                                            <div className="flex flex-col gap-1 flex-1 min-w-0">
                                                <div className="flex items-center gap-2">
                                                    <h3 className="text-lg font-semibold truncate">{printer.name}</h3>
                                                    <Chip
                                                        size="sm"
                                                ...
                                                <p className="text-sm text-default-500 truncate">{printer.connection}</p>
                                            </div>
                                        </div>
                                    </CardHeader>
                                    <CardBody className="pt-0">
                                        <div className="flex flex-col gap-3">
                                            ...
                                            <div className="flex items-center justify-between text-sm">
                                                ...
                                                <Chip size="sm" color={printer.printLogo ? "success" : "default"} variant="flat">
                                                    {printer.printLogo ? "Sim" : "Não"}
                                                </Chip>
                                            </div>
                                            <div className="flex items-center justify-between text-sm">
                                                <span className="text-default-500">Rodapé:</span>
                                                <Chip size="sm" color={printer.printFooter ? "success" : "default"} variant="flat">
                                            ...
                                            <div className="flex gap-2">
                                                <Button
                                                    ...
                                                    variant="flat"
                                                    color="primary"
                                                    startContent={<Document size={16} weight="Outline" />}
                                                    className="flex-1"
                                                ...
                                                <Button
                                                    ...
                                                    variant="flat"
                                                    color="default"
                                                    startContent={<Settings size={16} weight="Outline" />}
                                                    isIconOnly
                            ...
                            <div className="col-span-3 flex flex-col items-center justify-center py-12 text-center">
                                <Printer size={64} weight="Outline" className="text-default-300 mb-4" />
                                <p className="text-sm text-default-400">
                                    {search ? "Nenhuma impressora encontrada" : "Nenhuma impressora cadastrada"}
                                </p>
                    ...
                    {(onClose) => (
                        <>
                            <ModalHeader>
                                <div className="flex items-center gap-2">
                                    <Printer size={24} weight="Outline" className="text-primary" />
                                    <span>{editingPrinterId ? "Editar Impressora" : "Adicionar Impressora"}</span>
                                </div>
                            </ModalHeader>
                            <Divider />
                            <ModalBody className="flex flex-col gap-4 py-6">
                                ...
                                <Select
                                    ...
                                    onSelectionChange={(keys) => {
                                        const selected = Array.from(keys)[0] as Printer["paperSize"];
                                ...
                                <div className="flex items-center justify-between p-4 rounded-lg bg-default-100">
                                    <div className="flex flex-col flex-1">
                                        ...
                                        <span className="text-sm text-default-500">Incluir logo na nota fiscal</span>
                                    </div>
                                    <Switch
                                        isSelected={formData.printLogo}
                                        onValueChange={(value) => setFormData({ ...formData, printLogo: value })}
                                    />
                                </div>
                                ...
                                <div className="flex items-center justify-between p-4 rounded-lg bg-default-100">
                                    <div className="flex flex-col flex-1">
                                        ...
                                        <span className="text-sm text-default-500">Incluir rodapé na nota fiscal</span>
                                    </div>
                                    <Switch
                                        isSelected={formData.printFooter}
                                        onValueChange={(value) => setFormData({ ...formData, printFooter: value })}
                                    />
                                </div>
                                ...
                                <div className="flex items-center justify-between p-4 rounded-lg bg-default-100">
                                    <div className="flex flex-col flex-1">
                                        ...
                                        <span className="text-sm text-default-500">Impressora está ativa e funcionando</span>
                                    </div>
                                    <Switch
