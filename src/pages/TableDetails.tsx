...
export function TableDetailsPage() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      setBills(
        Array.isArray(billsRes.data) ? billsRes.data : billsRes.data.bills || []
      );
    } catch (error) {
      ...
      <div className="flex items-center gap-4 p-6 bg-background border-b border-default-200">
        ...
        <div className="flex flex-col">
          ...
          <p className="text-small text-default-500">
            Detalhes dos pedidos e comandas
          </p>
        </div>
      </div>
          ...
          <div className="flex flex-col gap-6 max-w-4xl mx-auto">
            ...
            >
              {Object.entries(ordersByBill).map(([billId, billOrders]) => {
                ...
                const billTotal = billOrders.reduce(
                  (sum, o) => sum + o.total,
                  0
                );
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex flex-col">
                            ...
                            <span className="text-tiny text-default-500">
                              {billOrders.length} pedido
                              {billOrders.length > 1 ? "s" : ""}
                            </span>
                          </div>
                        </div>
                  ...
                  >
                    <div className="flex flex-col gap-3 pb-4 pt-2">
                      {billOrders.map((order) => (
                        <div
                          key={order.id}
                          className="flex flex-col p-4 bg-default-50 rounded-xl border border-default-100"
                        >
