...
export function WhatsAppPage() {
  const [config, setConfig] = useState<WhatsAppConfig>({
    ...
    apiToken: "",
    welcomeMessage:
      "Olá! Bem-vindo ao nosso restaurante. Como posso ajudar você hoje?",
    autoReply: true,
    autoReplyMessage:
  ...
  const handleTestConnection = () => {
    ...
    toast.info(
      "Testando conexão. Verificando conexão com a API do WhatsApp..."
    );
  ...
  const handleReset = () => {
    ...
    toast.info(
      "Configuração resetada. As configurações foram restauradas aos valores padrão"
    );
  };
